	...
	public void doImageUndstortion(){
		...
		for(int r = 0; r < numCorresp; r++)
		{
			...
			for(int i = 0; i <= degree; i++)
			{
				...
				{
					// TODO:
					double curX = Xu2_vec.getElement(r);
					double curY = Yu2_vec.getElement(r);
		...
		SimpleMatrix Ainv = svd.inverse(true);
		
		// Compute the distortion coefficients
		// TODO
		SimpleVector u_vec = SimpleOperators.multiply(Ainv, Xd2_vec);
		// TODO
		SimpleVector v_vec = SimpleOperators.multiply(Ainv, Yd2_vec);
