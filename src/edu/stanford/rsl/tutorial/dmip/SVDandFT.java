...
public class SVDandFT {
	...
	{			
		...
		// iterate over diagonal of S, get the values and set the inverted values to the corresponding position in SinvDiag
		for (int i = 0; i < Sinv.getRows(); i++)
			{
			if(svd.getreciprocalS().getElement(i, i) != 0)
				{				
				double tmp = 1.0 / svd.getS().getElement(i, i);
				SinvDiag.setElementValue(i,tmp);
				}
			}
	...
	public static void optimizationProblem2(SimpleMatrix b)
	{
		...
		{	
			...
			//Setup measurement matrix M --> like slide 26 bottom line
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/of63ecyl/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/yu_fill.jpg";
		...
		String filenameShepp = "/proj/i5dmip/of63ecyl//Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/sheppLoganPhantom.tif";
